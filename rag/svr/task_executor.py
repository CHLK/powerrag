...
async def do_handle_task(task):
    ...
    try:
        if not await _maybe_insert_es(chunks):
            return stage_timings
        stage_timings[TaskStage.INSERT_INDEX] = timer() - start_ts
...
/___/_/ /_/\__, /\___/____/\__/_/\____/_/ /_/  /____/\___/_/    |___/\___/_/
    ...
    report_task_statistics_task = asyncio.create_task(report_task_statistics())
    tasks = []
    try:
        ...
        report_task_statistics_task.cancel()
        await asyncio.gather(report_task_statistics_task, return_exceptions=True)
